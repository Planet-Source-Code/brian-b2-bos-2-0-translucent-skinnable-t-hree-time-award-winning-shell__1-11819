...
Sub LoadSkinImages()
    For i = 0 To 3
        picItem(i).Picture = LoadPicture(GetSkinImage("Start Menu\Help Menu\Normal\Image" & i & ".bmp"))
        picItemOver(i).Picture = LoadPicture(GetSkinImage("Start Menu\Help Menu\Over\Image" & i & ".bmp"))
    Next
End Sub
...
Private Sub picItem_MouseDown(Index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Select Case Index
        ...
        Case 2
            ShellFile "http://b.pokecenter2000.com"
        Case 3
            frmHelpBrowse.Show
    End Select
End Sub
