...
Begin VB.Form frmSettingsMenu 
   ...
   End
End
Attribute VB_Name = "frmSettingsMenu"
...
Sub LoadSkinImages()
    For i = 0 To 3
        picItem(i).Picture = LoadPicture(GetSkinImage("Start Menu\Settings Menu\Normal\Image" & i & ".bmp"))
        picItemOver(i).Picture = LoadPicture(GetSkinImage("Start Menu\Settings Menu\Over\Image" & i & ".bmp"))
    Next
End Sub
